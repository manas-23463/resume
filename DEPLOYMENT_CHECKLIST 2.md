...
6. **Environment Variables**:
   ...
   - `FIREBASE_SERVICE_ACCOUNT_KEY` = `{"type":"service_account","project_id":"resume-screener-84800",...}` (single-line JSON)
   - `FIREBASE_PROJECT_ID` = `resume-screener-84800`
   - `SMTP_SERVER` = `email-smtp.us-east-1.amazonaws.com` (optional)
...
| `FIREBASE_SERVICE_ACCOUNT_KEY` | Firebase service account JSON (single-line, project: resume-screener-84800) | ✅ Yes |
| `FIREBASE_PROJECT_ID` | Firebase project ID (resume-screener-84800) | ✅ Yes |
